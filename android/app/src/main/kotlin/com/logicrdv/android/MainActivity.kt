    ...
    private val sessionListener: SessionListener = object: SessionListener {
        override fun onConnected(session: Session) {
           ...
           if (publisher != null && subscriber != null)
            {
             Log.d("MainActivity", "Two User")
           
//            notifyFlutter(SdkState.LOGGED_IN,flutterEngine)
...
//            notifyFlutter(SdkState.ONE_USER,flutterEngine)
                     //   session.publish(publisher)
...
//            notifyFlutter(SdkState.LOGGED_OUT,flutterEngine)
        }
...
//                notifyFlutter(SdkState.ONE_USER,flutterEngine)
        ...
        override fun onError(session: Session, opentokError: OpentokError) {
            ...
            Log.d("MainActivity", " Session id : ${session.sessionId}")
            Log.d("MainActivity", " Publisher :"+ publisher)
            Log.d("MainActivity", " Subscriber :"+ subscriber)
...
//            notifyFlutter(SdkState.ERROR,flutterEngine)
        }
    }
...
//            notifyFlutter(SdkState.ERROR,flutterEngine)
    ...
    override fun configureFlutterEngine(@NonNull flutterEngine: FlutterEngine) {
        ...
        addFlutterChannelListener(flutterEngine)
    }

    private fun addFlutterChannelListener(flutterEngine: FlutterEngine) {
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "com.vonage").setMethodCallHandler { call, result ->
            ...
            when (call.method) {
                "initSession" -> {
                    ...
                    notifyFlutter(SdkState.WAIT,flutterEngine)
  ...
  private fun closeSession() {
    ...
    private fun notifyFlutter(state: SdkState,flutterEngine: FlutterEngine) {
