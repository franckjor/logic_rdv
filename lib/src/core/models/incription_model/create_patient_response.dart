...
abstract class CreatePatientResponse
  ...
  String toJson() {
    return json.encode(serializers.serializeWith(CreatePatientResponse.serializer, this));
  }

  static CreatePatientResponse fromJson(String jsonString) {
    return serializers.deserializeWith(CreatePatientResponse.serializer, json.decode(jsonString))!;
  }
...
abstract class ParamsCreatePatientResponse
    implements Built<ParamsCreatePatientResponse, ParamsCreatePatientResponseBuilder> {
  ParamsCreatePatientResponse._();

  factory ParamsCreatePatientResponse([updates(ParamsCreatePatientResponseBuilder b)]) =
      _$ParamsCreatePatientResponse;
  ...
  String toJson() {
    return json.encode(serializers.serializeWith(ParamsCreatePatientResponse.serializer, this));
  }

  static ParamsCreatePatientResponse fromJson(String jsonString) {
    return serializers.deserializeWith(ParamsCreatePatientResponse.serializer, json.decode(jsonString))!;
  }
