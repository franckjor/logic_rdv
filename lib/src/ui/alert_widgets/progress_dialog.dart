...
import 'package:logic_rdv_v0/src/ui/themes/styles.dart';
    ...
    return SizedBox(
        ...
        child: Row(children: <Widget>[
          ...
          SizedBox(
            width: 75.0,
            child: Image.asset(
              'assets/gif/point_loading.gif',
            ),
          ),
          const SizedBox(width: 15.0),
          Expanded(
            child: _progressDialogType == ProgressDialogType.Normal
                ? Text(_dialogMessage, style: AppTextStyles.display21Style)
                : Stack(
                    children: <Widget>[
                      Positioned(
                        child: Text(_dialogMessage,
                            style: AppTextStyles.display1Style),
                        top: 35.0,
                      ),
                      Positioned(
